          ...
          <div class="box-body">
            <form class="" action="{{route('admin.tours.update', $tour->id)}}" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <input type="file" id="exampleInputFile" name="photo1" accept="image/x-png,image/gif,image/jpeg,image/x-MS-bmp" value="{{$tour->photo1}}">
                <p class="help-block">Maksimal Foto 1 MB.</p>
              ...
              <div class="form-group">
                ...
                <input type="file" id="exampleInputFile" name="photo2" accept="image/x-png,image/gif,image/jpeg,image/x-MS-bmp" value="{{$tour->photo2}}">
                <p class="help-block">Maksimal Foto 1 MB.</p>
              ...
              <div class="form-group">
                ...
                <input type="file" id="exampleInputFile" name="photo3" accept="image/x-png,image/gif,image/jpeg,image/x-MS-bmp" value="{{$tour->photo3}}">
                <p class="help-block">Maksimal Foto 1 MB.</p>
              ...
              <div class="form-group">
                ...
                <input type="file" id="exampleInputFile" name="photo4" accept="image/x-png,image/gif,image/jpeg,image/x-MS-bmp" value="{{$tour->photo4}}">
                <p class="help-block">Maksimal Foto 1 MB.</p>
              ...
              <div class="form-group">
                ...
                <input type="file" id="exampleInputFile" name="photo5" accept="image/x-png,image/gif,image/jpeg,image/x-MS-bmp" value="{{$tour->photo5}}">
                <p class="help-block">Maksimal Foto 1 MB.</p>
              ...
              <div class="form-group">
                ...
                <input type="file" id="exampleInputFile" name="photo6" accept="image/x-png,image/gif,image/jpeg,image/x-MS-bmp" value="{{$tour->photo6}}">
                <p class="help-block">Maksimal Foto 1 MB.</p>
              ...
              <div class="form-group">
                ...
                <input type="file" id="exampleInputFile" name="photo7" accept="image/x-png,image/gif,image/jpeg,image/x-MS-bmp" value="{{$tour->photo7}}">
                <p class="help-block">Maksimal Foto 1 MB.</p>
              ...
              <div class="form-group">
                ...
                <input type="file" id="exampleInputFile" name="photo8" accept="image/x-png,image/gif,image/jpeg,image/x-MS-bmp" value="{{$tour->photo8}}">
                <p class="help-block">Maksimal Foto 1 MB.</p>
              ...
              <div class="form-group">
                ...
                <input type="file" id="exampleInputFile" name="photo9" accept="image/x-png,image/gif,image/jpeg,image/x-MS-bmp" value="{{$tour->photo9}}">
                <p class="help-block">Maksimal Foto 1 MB.</p>
