      ...
      <div class="row d-flex justify-content-center" style="padding-bottom:0px;">
        <div class="menu-content col-lg-12">
          <div class="title text-center">
            <h4 style="margin-top: -20px;margin-bottom: 10px; color:#004785"><b style="color:#004785;">Villa Terbaik</b></h4>
              ...
              <a href="{{route('villas.show', $villa->name)}}">
                ...
                margin-bottom:10px;">
                  <div style="position: relative; text-align: center; color: white; width: 100%;">
                    <img src="https://lepassuntuk.com/photos/villas/{{$villa->user_id}}/{{$villa->id}}/{{$villa->main_photo}}" style="height: 120px;  width: 100%; object-fit: cover; display: inline;border-radius: 3%;">
