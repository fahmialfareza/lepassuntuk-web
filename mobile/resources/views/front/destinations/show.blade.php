...
<head>
  ...
  <title>Destinasi Pilihan di {{$destination->name}} | Lepas Suntuk</title>
      ...
      <div class="row d-flex justify-content-center" style="padding-bottom:0px;">
        <div class="menu-content col-lg-12">
          <div class="title text-center">
            <h4 style="margin-top: -20px;margin-bottom: 10px; color:#004785"><b style="color:#004785;">Destinasi Pilihan di {{$destination->name}}</b></h4>
