        ...
        <div class="row d-flex justify-content-center" style="padding-bottom:0px;">
          <div class="menu-content col-lg-12">
            <div class="title text-center">
              <h4 style="margin-top: -20px;margin-bottom: 10px; color:#004785"><b style="color:#004785;">Daftar Mobil</b></h4>
            </div>
          </div>
        </div>
      </div>
                ...
                <a data-toggle="modal" data-target="#myModal{{$car->id}}">
                  <div class="col-xs-6" style="
                    ...
                    <div style="position: relative; text-align: center; color: white; width: 100%;">
                      <img src="https://lepassuntuk.com/photos/carrentals/{{$car->user_id}}/{{$car->id}}/{{$car->photo}}" style="height: 120px;  width: 100%; object-fit: cover; display: inline;border-radius: 3%;">
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-header">
                        <div class="row">
                          <div class="col-xs-10">
                            <h4 class="modal-title">{{$car->brand}} {{$car->type}}</h4>
                          </div>
                          <div class="col-xs-2">
