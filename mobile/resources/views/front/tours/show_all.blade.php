...
<head>
  <title>Paket Seru-Seruan | Lepas Suntuk</title>
...
<body>
  ...
  <section style="min-height:400px;background-image: url('https://lepassuntuk.com/img/header-paketwisata.jpg');background-repeat:no-repeat;
    width: 100%;background-size:  contain; display: table;max-width: none;padding-top:15px; margin-bottom: -352px; margin-top: 66px; ">
  </section>

  <section style="padding-top:30px;padding-bottom:0px;margin-top:55px; background: #ffffff;">
    <div class="container">
      <div class="row d-flex justify-content-center" style="padding-bottom:0px;">
        <div class="menu-content col-lg-12">
          <div class="title text-center">
            <h4 style="margin-top: -20px;margin-bottom: 10px; color:#004785"><b style="color:#004785;">Paket Seru-Seruan</b></h4>
                  ...
                  <div style="position: relative; text-align: center; color: white; width: 100%;">
                    ...
                    <div class="bottom-left" style="width:100%;  position: absolute; bottom: 0px; left: 0px;">
                      <div class="col-xs-12 text-center" style="padding:5px; color:#fff; background: rgba(143, 153, 159, 0.5);">
                        <b>
                          <p style="color:#fff;text-shadow: 2px 2px 4px #000000; line-height: 17px;margin-bottom: 1px;">{{$tour->name}}</p>
                        </b>
                      </div>
                    </div>
                  </div>
