  ...
  <section class="destinations-area section-gap" style="padding-top:0px;padding-bottom:10px;padding-top:0px; background: #ffffff;">
    <div class="container">
          ...
          <div class="row">
            @foreach($destinations as $destination)
              <a href="{{route('destinations.show', $destination->id)}}">
                <div class="col-xs-6" style="padding-right: 4px;margin-bottom:10px;">
                  <div style="position: relative; text-align: center; color: white; width: 100%;">
                    <img src="/photos/destinations/{{$destination->user_id}}/{{$destination->id}}/{{$destination->photo}}" style="height: 120px;  width: 100%; object-fit: cover; display: inline;border-radius: 3%;">
      ...
      <div class="text-center">
        <a href="#" class="genric-btn primary circle arrow">Next<span class="lnr lnr-arrow-right"></span></a>
      </div>
    </div>
  </section>
</body>
