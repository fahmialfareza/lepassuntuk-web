        ...
        <div class="box box-default">
          ...
          <div class="box-body">
            <form class="" action="{{route('admin.villa.update', $villa->id)}}" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                <label>Harga *</label>
                <input type="number" name="price" class="form-control" placeholder="Contoh : 500000" value="{{$villa->price}}" required>
                @if ($errors->has('price'))
                  <span class="help-block">
              ...
              <div class="form-group">
                ...
                <input type="text" name="spot1" class="form-control" placeholder="Contoh : Ruang Utama" value="{{old('spot1', $villa->spot1)}}">
                @if ($errors->has('spot1'))
                  <span class="help-block">
              ...
              <div class="form-group">
                ...
                <input type="text" name="spot2" class="form-control" placeholder="Contoh : Ruang Utama" value="{{old('spot2', $villa->spot2)}}">
                @if ($errors->has('spot2'))
                  <span class="help-block">
              ...
              <div class="form-group">
                ...
                <input type="text" name="spot3" class="form-control" placeholder="Contoh : Ruang Utama" value="{{old('spot3', $villa->spot3)}}">
                @if ($errors->has('spot3'))
                  <span class="help-block">
              ...
              <div class="form-group">
                ...
                <input type="text" name="spot4" class="form-control" placeholder="Contoh : Ruang Utama" value="{{old('spot4', $villa->spot4)}}">
                @if ($errors->has('spot4'))
                  <span class="help-block">
              ...
              <div class="form-group">
                ...
                <input type="text" name="spot5" class="form-control" placeholder="Contoh : Ruang Utama" value="{{old('spot5', $villa->spot5)}}">
                @if ($errors->has('spot5'))
                  <span class="help-block">
              ...
              <div class="form-group">
                ...
                <input type="text" name="spot6" class="form-control" placeholder="Contoh : Ruang Utama" value="{{old('spot6', $villa->spot6)}}">
                @if ($errors->has('spot6'))
                  <span class="help-block">
              ...
              <div class="form-group">
                ...
                <input type="text" name="spot7" class="form-control" placeholder="Contoh : Ruang Utama" value="{{old('spot7', $villa->spot7)}}">
                @if ($errors->has('spot7'))
                  <span class="help-block">
              ...
              <div class="form-group">
                ...
                <input type="text" name="spot8" class="form-control" placeholder="Contoh : Ruang Utama" value="{{old('spot8', $villa->spot8)}}">
                @if ($errors->has('spot8'))
                  <span class="help-block">
              ...
              <div class="form-group">
                ...
                <input type="text" name="spot9" class="form-control" placeholder="Contoh : Ruang Utama" value="{{old('spot9', $villa->spot9)}}">
                @if ($errors->has('spot9'))
                  <span class="help-block">
