...
<head>
  ...
  <title>Tambah Paket Wisata | Paket Wisata | Admin | Lepas Suntuk</title>
      ...
      <section class="content">
        ...
        <div class="box box-default">
          <div class="box-header with-border">
            <h3 class="box-title">Tambah Paket Wisata</h3> <br>
          </div>
          <div class="box-body">
            <form class="" action="{{route('admin.tours.store')}}" method="post" enctype="multipart/form-data">
              {{csrf_field()}}
              ...
              <div class="form-group">
                <label>Nama *</label>
                <input type="text" name="name" class="form-control" placeholder="Contoh : Andre Schevchenko" value="{{old('name')}}" required>
                @if ($errors->has('name'))
                  <span class="help-block">
              ...
              <div class="form-group">
                <label>Slug *</label>
                <input type="text" name="slug" class="form-control" placeholder="Contoh : wisata-batu" value="{{old('slug')}}" required>
                @if ($errors->has('slug'))
                  <span class="help-block">
              ...
              <div class="form-group">
                <label>Lokasi *</label>
                <input type="text" name="location" class="form-control" placeholder="Contoh : Malang, Jawa Timur" value="{{old('location')}}" required>
                @if ($errors->has('location'))
                  <span class="help-block">
                    <strong>{{$errors->first('location')}}</strong>
                  </span>
              ...
              <div class="form-group">
                ...
                <input type="text" name="durations" class="form-control" placeholder="Contoh : 1" value="{{old('durations')}}" required>
              ...
              <div class="form-group">
                ...
                <textarea class="textarea" id="mytextarea2" placeholder="Fasilitas...." name="facilities"
                          style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{old('facilities')}}</textarea>
