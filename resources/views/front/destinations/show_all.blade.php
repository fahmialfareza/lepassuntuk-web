      ...
      <div class="row d-flex justify-content-center" style="padding-bottom:0px;">
        <div class="menu-content col-lg-12">
          <div class="title text-center">
            <h1 style="margin-top: -20px;margin-bottom: 10px; color:#004785"><b style="color:#004785;  font-family : 'Poppins';">Destinasi Pilihan</b></h1>
              ...
              <a href="/tours?destination_id={{$destination->id}}">
                <div class="col-md-4" style="
                  ...
                  <div style="position: relative; text-align: center; color: white; width: 100%;">
                    <img src="https://lepassuntuk.com/photos/destinations/{{$destination->user_id}}/{{$destination->id}}/{{$destination->photo}}" style="height: 300px;  width: 100%; object-fit: cover; display: inline;border-radius: 3%;">
