...
<head>
    ...
    <title> Kereta Api | Lepas Suntuk</title>
    ...
    <!--srart theme style -->
    <link href="tambahan/css/main.css" rel="stylesheet" type="text/css"/>
    <!-- end theme style -->
    <!-- favicon links -->
    ...
    <div class="full_width Travelite_coming_soon_wrapper">
	 <div class="container">
		...
		<div class="coming_soon_heading">
			<h2>Coming Soon!</h2>
			<p>Fitur Pencarian Kereta Api Akan Segera Hadir!</p>
		</div>
		<div id="counter_comming_soon"  data-countdown="2016/05/01"></div>
		<div class="full_width newsletter_wrapper_main">
			<form>
			 <p>Please sign-up for our newsletter</p>
			   <div class="email_newsletter">
				 <input type="email" placeholder="Your Email Id" class="news_email">
