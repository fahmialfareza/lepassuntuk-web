...
<body>
  ...
  <div style="padding-top:0px;padding-bottom:15px;margin-top:0px; background: #3884C2;">
   ...
   <div class="container">
    <div class="row">   
	<div class="col-md-12">
      <ol class="breadcrumb" style="width:100%;padding:15px;border-radius:18px;background-color:#fff;margin-bottom:0px;margin-top: 30px;">
        <li>1. Pesan</li>
        <li>2. Review</li>
        <li class="active">3. Pembayaran</li>
      </ol>
    </div>
    </div>
    </div>
  ...
  <div style="margin-top:0px;padding: 18px;">
    <div class="container" style="padding:15px;border-radius:15px;background:#fff">
      <div class="col-md-12" style="">
        ...
        <p style="color:#000;font-weight:500; text-align: center;">Silahkan lakukan pembayaran melalui transfer Bank BCA ke nomor rekening BCA 3151012955 a.n Fadil Muarif.
        </p>
        <p style="color:#000;font-weight:500; text-align: center;">Setelah melakukan pembayaran, harap melakukan konfirmasi ke WA 081259807887 dengan mengirim bukti transfer
        </p>
        <div class="text-center">
        ...
        <div class="text-center" style="margin-bottom:15px;">
          <a href="{{route('user.bookings.index')}}" class="btn btn-block" style="background-color:#F29B00;color:#fff; width:">Kembali ke Awal<a>
        </div>
