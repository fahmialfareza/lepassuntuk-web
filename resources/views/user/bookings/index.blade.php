...
<body>
    ...
    <div style="margin-top:75px;padding: 18px;">
        ...
        <div class="container" style="padding:15px;border-radius:15px;background:#fff;width:1000px;">
          @if (session('status'))
          ...
          @foreach($bookings->sortByDesc('id') as $booking)
            <div class="col-md-12" style="">
                ...
                <a href="{{route('user.bookings.review', $booking->id)}}" class="btn" style="background-color:#F29B00;color:#fff;margin-bottom:15px;">Review Booking</a>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <th style="color:#000;font-weight:500;font-size: small;" class="text-right">
                                  @if (($booking->confirmation == null && $booking->confirmation !== 0) && (\Carbon\Carbon::now() < $booking->expired))
                                    <a target="_blank" href="http://api.whatsapp.com/send?phone=6281259807887&&text=Konfirmasi Pembayaran kode booking LS-505{{$booking->id}} dengan bukti di bawah ini" style="margin-bottom: 5px; margin-top: 5px;" class="btn btn-success">Konfirmasi<a>
