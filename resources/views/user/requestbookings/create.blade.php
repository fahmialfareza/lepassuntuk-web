...
<div style="background-color:#E5E5E5;margin-bottom:35px;">
    <div style="width:800px; margin:auto;padding-top:115px;">
    <section class="destinations-area section-gap" style="padding-top:55px;padding-bottom:0px;background: #ffffff;">
        <div class="">
            <div class="row d-flex justify-content-center" style="padding-bottom:0px;">
                <div class="menu-content col-lg-12" style="width: 800px">
        ...
        <div style="padding:15px;">
          <form class="" action="{{route('user.requestbookings.store')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                @if (session('status'))
                    <div class="alert alert-success text-center" role="alert">
                        Terima kasih atas permintaan Anda, kami akan membalas maksimal 1 x 24 Jam
                        <!--{{session('status')}}-->
                    </div>
                @endif
            ...
            <div class="text-center">
              <button type="submit" style="border-radius: 7px; text-align: center; display: inline-flex; flex-direction: column; justify-content: center; align-items: center; width: 30%" class="genric-btn primary btn-block arrow mb-10">
                    Kirim Request
              </button>
            </div>
            <!--<p style="text-align: center;">Terima kasih atas permintaan Anda, kami akan membalas maksimal 1 x 24 Jam.</p>-->
          </form>
          <br>
