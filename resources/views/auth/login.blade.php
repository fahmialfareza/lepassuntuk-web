...
<head>
    ...
    <meta charset="UTF-8">
    <!-- Site Title -->
    <title>Login | Lepas Suntuk</title>
...
">
            <div class="row">
                <div class="col-lg-12 form-group" style="margin-bottom:0px">
                    ...
                    <input id="email" type="email" class="mb-10 form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" placeholder="Masukkan Email" required autofocus>
            ...
            <div class="col-lg-12 form-group text-center">
                <a href="{{ route('password.request') }}" class="" style="">Lupa Password</a>
            </div>
            <div class="col-lg-12 form-group text-center">
                <a href="/register">Belum Mendaftar? <b>Daftar Sekarang</b></a>
            </div>
            ...
            <div class="col-lg-12 form-group text-center">
                <p class="garis" href="">Atau masuk dengan</b></p>
            </div>
            <div class="col-lg-12 form-group text-center" style="color:#337ab7;">
                <a href="{{ url('/auth/facebook') }}"><span class="fa fa-facebook-square fa-3x"></span></a>
                <a href="{{ url('/auth/google') }}"><span class="fa fa-google-plus-square  fa-3x"></span></a>
            </div>
        </div>
      </form>
      </section>
